  ...
  <v-card>
    <v-card-text>
      ...
      <v-row justify="center" cols="3">
        ...
        <v-col @change="changeHu">
          <v-select v-model="hu" :items="huItems" label="符" />
        </v-col>
        <v-col>
      ...
      <v-row justify="center">
        <v-col class="font-weight-thin headline">
          {{ tokuten }}
        </v-col>
      </v-row>
      <v-divider></v-divider>
      <v-row justify="center" cols="5">
        ...
        <v-col>
          <v-btn rounded small color="red" dark @click="reach(editedItem, '1')"
            >リーチ</v-btn
          >
        </v-col>
      </v-row>
      <v-row justify="center" cols="5">
        ...
        <v-col>
          <v-text-field
            v-model="editedItem.secondScore"
            label="点数"
          ></v-text-field>
        </v-col>
        <v-col>
        ...
        <v-col>
          <v-btn rounded small color="red" dark @click="reach(editedItem, '2')"
            >リーチ</v-btn
          >
        </v-col>
      </v-row>
      <v-row justify="center" cols="5">
        ...
        <v-col>
          <v-btn rounded small color="red" dark @click="reach(editedItem, '3')"
            >リーチ</v-btn
          >
        </v-col>
      </v-row>
      <v-row justify="center">
        ...
        <v-col>
          <v-text-field
            v-model="editedItem.fourthScore"
            label="点数"
          ></v-text-field>
        </v-col>
        <v-col>
        ...
        <v-col>
          <v-btn rounded small color="red" dark @click="reach(editedItem, '4')"
            >リーチ</v-btn
          >
        </v-col>
      </v-row>
      <v-row justify="center">
        <v-col>
          <v-btn depressed small @click="liquidation(editedItem, calcuVar)"
            >清算</v-btn
          >
        </v-col>
      </v-row>
