    ...
    <v-content>
            ...
            <v-toolbar flat color="white">
              ...
              <v-dialog v-model="newRoomDialog" max-width="500px">
                ...
                <v-card>
                  ...
                  <v-card-actions>
                    <v-spacer></v-spacer>
                    <v-btn color="blue darken-1" text @click="closeNewRoomDialog(editedItem, calcuVar)">close</v-btn>
                    <v-btn color="blue darken-1" text @click="reset(editedItem)">Reset</v-btn>
      ...
      <div v-show="playingRoom">
        ...
        <v-row justify="center">
          ...
          <v-col cols="1" sm="1" md="1">
            <v-btn depressed small color="warning" @click="calcuHan(roomItem)">翻計算</v-btn>
          </v-col>
          <v-col cols="1" sm="1" md="1">
            <v-select
            v-model="hu"
          ...
          <v-col cols="1" sm="1" md="1">
            <v-btn depressed small color="primary" @click="calcuHu(roomItem)">符計算</v-btn>
          </v-col>
        </v-row>
        <v-row justify="center">
          ...
          <v-col cols="2" justify="end">
            <v-btn class="mx-3" depressed small color="amber lighten-3" @click="calculateTokuten">計算</v-btn>
            <v-btn depressed small color="brown lighten-3" @click="ryukyoku">流局</v-btn>
            <v-btn class="mx-3" depressed small @click="clearScreen">クリア</v-btn>
          </v-col>
        </v-row>
        <v-row justify="center">
        ...
        <v-row justify="center">
          <v-col cols="1" sm="1" md="1">
            <v-text-field v-model="roomItem.firstName" readonly label="東家"></v-text-field>
          </v-col>
          <v-col cols="1" sm="1" md="1">
            <v-text-field v-model="roomItem.firstScore" label="点数"></v-text-field>
          </v-col>
          <v-col cols="1" sm="1" md="1">
          ...
          <v-col cols="1" sm="1" md="1">
            <v-btn rounded small color="red" dark @click="reach(roomItem, '1')">リーチ</v-btn>
          </v-col>
        </v-row>
        <v-row justify="center">
          <v-col cols="1" sm="1" md="1">
            <v-text-field v-model="roomItem.secondName" readonly label="南家"></v-text-field>
          </v-col>
          <v-col cols="1" sm="1" md="1">
            <v-text-field v-model="roomItem.secondScore" label="点数"></v-text-field>
          </v-col>
          <v-col cols="1" sm="1" md="1">
          ...
          <v-col cols="1" sm="1" md="1">
            <v-btn rounded small color="red" dark @click="reach(roomItem, '2')">リーチ</v-btn>
          </v-col>
        </v-row>
        <v-row justify="center">
          <v-col cols="1" sm="1" md="1">
            <v-text-field v-model="roomItem.thirdName" readonly label="西家"></v-text-field>
          </v-col>
          <v-col cols="1" sm="1" md="1">
            <v-text-field v-model="roomItem.thirdScore" label="点数"></v-text-field>
          </v-col>
          <v-col cols="1" sm="1" md="1">
          ...
          <v-col cols="1" sm="1" md="1">
            <v-btn rounded small color="red" dark @click="reach(roomItem, '3')">リーチ</v-btn>
          </v-col>
        </v-row>
        <v-row justify="center">
          <v-col cols="1" sm="1" md="1">
            <v-text-field v-model="roomItem.fourthName" readonly label="北家"></v-text-field>
          </v-col>
          <v-col cols="1" sm="1" md="1">
            <v-text-field v-model="roomItem.fourthScore" label="点数"></v-text-field>
          </v-col>
          <v-col cols="1" sm="1" md="1">
          ...
          <v-col cols="1" sm="1" md="1">
            <v-btn rounded small color="red" dark @click="reach(roomItem, '4')">リーチ</v-btn>
          </v-col>
        </v-row>
        <v-row justify="center">
          <v-col cols="1" sm="1" md="1">
            <v-btn tile color="indigo" dark @click="liquidation(roomItem, calcuVar)">清算</v-btn>
          </v-col>
        </v-row>            
        <v-row justify="center">
          <v-col cols="1" sm="1" md="1">
          ...
          <v-col cols="1" sm="1" md="1">
            <v-btn text color="blue darken-1" @click="saveBattleResult">Save</v-btn>
          </v-col>
        </v-row>
      </div>
    </v-content>
...
function getTokuten(basuu, reachBou, tokutenKey, manganIjouKey, oyako, agari){
  ...
  if(manganIjouKey < MANGAN_MIMAN){
    ...
    tokuten = getTokutenManganMiman(tokutenkeyManganMiman, oyako, totalBaRyou, agari)

  }else{

    tokuten = getTokutenHanemanIjou(tokutenKeyHanemanIjou, oyako, totalBaRyou, agari)
...
function getTokutenManganMiman(key, oyako, totalBaRyou, agari){
  ...
  var konoTokutenMap = new Map([
                                                                                                                   ...
                                                                                                                   ["2020", "400,700"],   ["2030", "700,1300"],      ["2040", "1300,2600"],
                      ["2521", "1600"],  ["2531", "3200"],         ["2541", "6400"],                                                      ["2530", "800,1600"],      ["2540", "1600,3200"],
    ["3011", "1000"], ["3021", "2000"],  ["3031", "3900"],         ["3041", "7700"],         ["3010", "300,500"],  ["3020", "500,1000"],  ["3030", "1000,2000"],     ["3040", "2000,3900"],
    ["4011", "1300"], ["4021", "2600"],  ["4031", "5200"],         ["4041", KONOMANGAN_RON], ["4010", "400,700"],  ["4020", "700,1300"],  ["4030", "1300,2600"],     ["4040", KONOMANGAN_TUMO],
    ["5011", "1600"], ["5021", "3200"],  ["5031", "6400"],         ["5041", KONOMANGAN_RON], ["5010", "400,800"],  ["5020", "800,1600"],  ["5030", "1600,3200"],     ["5040", KONOMANGAN_TUMO],
    ["6011", "2000"], ["6021", "3900"],  ["6031", "7700"],         ["6041", KONOMANGAN_RON], ["6010", "500,1000"], ["6020", "1000,2000"], ["6030", "2000,3900"],     ["6040", KONOMANGAN_TUMO],
    ["7011", "2300"], ["7021", "4500"],  ["7031", KONOMANGAN_RON], ["7041", KONOMANGAN_RON], ["7010", "600,1200"], ["7020", "1200,2300"], ["7030", KONOMANGAN_TUMO], ["7040", KONOMANGAN_TUMO],
    ["8011", "2600"], ["8021", "5200"],  ["8031", KONOMANGAN_RON], ["8041", KONOMANGAN_RON], ["8010", "700,1300"], ["8020", "1300,2600"], ["8030", KONOMANGAN_TUMO], ["8040", KONOMANGAN_TUMO],
    ["9011", "2900"], ["9021", "5800"],  ["9031", KONOMANGAN_RON], ["9041", KONOMANGAN_RON], ["9010", "800,1500"], ["9020", "1500,2900"], ["9030", KONOMANGAN_TUMO], ["9040", KONOMANGAN_TUMO],
    ["10011", "3200"],["10021", "6400"], ["10031", KONOMANGAN_RON],["10041", KONOMANGAN_RON],["10010", "800,1600"],["10020", "1600,3200"],["10030", KONOMANGAN_TUMO],["10040", KONOMANGAN_TUMO],
    ["11011", "3600"],["11021", "7100"], ["11031", KONOMANGAN_RON],["11041", KONOMANGAN_RON],["11010", "900,1800"],["11020", "1800,3600"],["11030", KONOMANGAN_TUMO],["11040", KONOMANGAN_TUMO]

  ])

  var oyanoTokutenMap = new Map([

                                                                                                                  ["2020", "700"],  ["2030", "1300"],           ["2040", "2600"],
                      ["2521", "2400"],   ["2531", "4800"],          ["2541", "9600"],                                              ["2530", "1600"],           ["2540", "3200"],
    ["3011", "1500"], ["3021", "2900"],   ["3031", "5800"],          ["3041", "11600"],         ["3010", "500"],  ["3020", "1000"], ["3030", "2000"],           ["3040", "3900"],
    ["4011", "2000"], ["4021", "3900"],   ["4031", "7700"],          ["4041", OYANOMANGAN_RON], ["4010", "700"],  ["4020", "1300"], ["4030", "2600"],           ["4040", OYANOMANGAN_TUMO],
    ["5011", "2400"], ["5021", "4800"],   ["5031", "9600"],          ["5041", OYANOMANGAN_RON], ["5010", "800"],  ["5020", "1600"], ["5030", "3200"],           ["5040", OYANOMANGAN_TUMO],
    ["6011", "2900"], ["6021", "5800"],   ["6031", "11600"],         ["6041", OYANOMANGAN_RON], ["6010", "1000"], ["6020", "2000"], ["6030", "3900"],           ["6040", OYANOMANGAN_TUMO],
    ["7011", "3400"], ["7021", "6800"],   ["7031", OYANOMANGAN_RON], ["7041", OYANOMANGAN_RON], ["7010", "1200"], ["7020", "2300"], ["7030", OYANOMANGAN_TUMO], ["7040", OYANOMANGAN_TUMO],
    ["8011", "3900"], ["8021", "7700"],   ["8031", OYANOMANGAN_RON], ["8041", OYANOMANGAN_RON], ["8010", "1300"], ["8020", "2600"], ["8030", OYANOMANGAN_TUMO], ["8040", OYANOMANGAN_TUMO],
    ["9011", "4400"], ["9021", "8700"],   ["9031", OYANOMANGAN_RON], ["9041", OYANOMANGAN_RON], ["9010", "1500"], ["9020", "2900"], ["9030", OYANOMANGAN_TUMO], ["9040", OYANOMANGAN_TUMO],
    ["10011", "4800"],["10021", "9600"],  ["10031", OYANOMANGAN_RON],["10041", OYANOMANGAN_RON],["10010", "1600"],["10020", "3200"],["10030", OYANOMANGAN_TUMO],["10040", OYANOMANGAN_TUMO],
    ["11011", "5300"],["11021", "10600"], ["11031", OYANOMANGAN_RON],["11041", OYANOMANGAN_RON],["11010", "1800"],["11020", "3600"],["11030", OYANOMANGAN_TUMO],["11040", OYANOMANGAN_TUMO]
...
function getTokutenHanemanIjou(key, oyako, totalBaRyou, agari){
  ...
  var hanemanIjouMap = new Map([
    ...
    ["501", "12000"],["500", "4000"],["511", "8000"],["510", "2000,4000"],
    ["601", "16000"],["600", "6000"],["611", "12000"],["610", "3000,6000"],
    ["701", "24000"],["700", "8000"],["711", "16000"],["710", "4000,8000"],
    ["801", "32000"],["800", "12000"],["811", "24000"],["810", "6000,12000"],
    ["901", "48000"],["900", "16000"],["911", "32000"],["910", "8000,16000"]
